    ...
    <div className="max-w-3xl mx-auto py-10 px-6">
      ...
      <form action={action} className="space-y-6">
        ...
        <div>
          ...
          <select id="choreographerUserId" name="choreographerUserId" className="w-full border border-gray-300 rounded px-3 py-2">
        ...
        <div>
          ...
          <input id="cut" name="cut" type="url" className="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400" placeholder="https://" />
        </div>
        <div>
          ...
          <input id="cleaningVideo" name="cleaningVideo" type="url" className="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400" placeholder="https://" />
        </div>
        <div>
          ...
          <input id="cleaningNote" name="cleaningNote" type="url" className="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400" placeholder="https://" />
        </div>
